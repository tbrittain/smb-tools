...
SMB4 allows you to export an existing franchise to a brand new league at any point — effectively taking your franchise history and continuing it in a fresh save game. smb-tools calls this a **fork**.
...
Do not use forking if you are simply correcting a wrong file selection — use the **replace** option on the active source instead.
