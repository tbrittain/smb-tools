...
//
//nolint:gocognit // 13-step sequential pipeline — each step depends on the previous step's output; decomposing would scatter the pipeline state across many call sites without reducing real complexity
func (svc *ImportService) importInTx(
	...
	// ── 5–8. Batting and pitching stats (regular season + playoffs) ─────────
	...
	// ── 9. Context stats (OPS+, ERA+, FIP, FIP-, smbWAR) ───────────────────
